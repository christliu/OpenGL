...
int main()
{
	...
	Shader shader("Shader/model.vs", "Shader/model.ps");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniformMatrix4fv(glGetUniformLocation(shader.m_shaderProgram, "projection"), 1, GL_FALSE, glm::value_ptr(projection));
