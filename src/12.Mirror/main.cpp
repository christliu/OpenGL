...
int main()
{
	...
	boxTexture = new OpenGLTexture(GL_TEXTURE_2D, "res/textures/marble.jpg");
	floorTexture = new OpenGLTexture(GL_TEXTURE_2D, "res/textures/metal.png");
	...
	GLuint mirroVBO, mirroVAO;
	glGenVertexArrays(1, &mirroVAO);
	glGenBuffers(1, &mirroVBO);
	glBindVertexArray(mirroVAO);
	glBindBuffer(GL_ARRAY_BUFFER, mirroVBO);
