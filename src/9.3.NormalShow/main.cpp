...
int main()
{
	...
	Shader normalShader("shader/9.3.NormalShow.vs", "shader/9.3.NormalShow.ps", "shader/9.3.NormalShow.gs");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		normalShader.Use();
		glUniformMatrix4fv(glGetUniformLocation(normalShader.m_shaderProgram, "model"), 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(glGetUniformLocation(normalShader.m_shaderProgram, "view"), 1, GL_FALSE, glm::value_ptr(view));
		glUniformMatrix4fv(glGetUniformLocation(normalShader.m_shaderProgram, "projection"), 1, GL_FALSE, glm::value_ptr(perspective));
