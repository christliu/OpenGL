...
int main()
{
	...
	Shader modelShader("shader/9.2.Explode.vs", "shader/model.ps", "shader/9.2.Explode.gs");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform1f(glGetUniformLocation(modelShader.m_shaderProgram, "time"), lastframe);
